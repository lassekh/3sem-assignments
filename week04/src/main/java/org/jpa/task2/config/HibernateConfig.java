...
import org.jpa.task1.PersonalDetails;
...
public class HibernateConfig {
    ...
    private static EntityManagerFactory buildEntityFactoryConfig() {
        try {
            ...
            props.put("hibernate.hbm2ddl.auto", "update"); // Set to "create" for overwriting / "update" for updating hibernate creates tables based on entities
    ...
    public static EntityManagerFactory getEntityManagerFactoryForTesting() {
        if (entityManagerFactory == null) entityManagerFactory = buildEntityFactoryConfig();
        return entityManagerFactory;
    }
}
